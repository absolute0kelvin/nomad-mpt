...
// PAGE_SIZE handling: on x86_64 it's defined in <sys/user.h>,
// but on ARM64 we need to use sysconf at runtime or define it manually.
#ifdef __x86_64__
    #include <sys/user.h> // for PAGE_SIZE
    #if PAGE_SIZE != 4096
        #error "Non 4Kb CPU PAGE_SIZE detected."
    #endif
#elif defined(__aarch64__)
    // ARM64: PAGE_SIZE is not defined at compile time, 
    // assume 4KB page size for now (Docker/Lima typically uses 4KB pages)
    #ifndef PAGE_SIZE
